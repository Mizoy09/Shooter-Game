...
BACKGROUND_SPRITE = "planet.jpg"
PLAYER_SPRITE = "rocket.png"
ENEMY_SPRITE = "ufo.png"
...
player = Player(PLAYER_SPRITE, win_width / 2, win_height - 100, 50, 70, 5)
...
while GAME_RUN:
    ...
    if not GAME_FINISHED:
        ...
        if spawnrate_enemy < 0:
            enemy = Enemy("ufo.png", randint(64, win_width - 64), -64, 64, 64, randint(1, 7))
